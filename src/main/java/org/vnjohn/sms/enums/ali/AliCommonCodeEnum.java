...
public enum AliCommonCodeEnum {
    ...
    AliCommonCodeEnum(String code, String message) {
        this.code = code;
        this.message = message;
    }

    public static AliCommonCodeEnum parseByCode(String code) {
        return Arrays.stream(AliCommonCodeEnum.values()).filter(aliCommonCodeEnum -> aliCommonCodeEnum.code.equals(code)).findFirst().orElse(null);
    }
