...
public final class JacksonUtils {
    ...
    public static <T> List<T> toObjs(String json, Class<T> cls) {
        try {
            return (List)mapper.readValue(json, TypeFactory.defaultInstance().constructCollectionType(List.class, cls));
        } catch (IOException e) {
            throw new NacosDeserializationException(cls, e);
        }
    }
